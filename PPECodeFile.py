...
with st.sidebar:
    ...
    st.markdown("Created by: Muhammad Talha Amjad")
...
if source == "Image":
    ...
    if source == "Image" and option == "Automatic" and st.session_state.detect_objects_pressed:
        ...
        supervisor_name = st.text_input(
            ...
            value="Muhammad Talha",  # Default value
            key="supervisor_name"
        )
    ...
    if option == "Automatic":
        ...
        if st.session_state.snapshot_taken and st.session_state.snapshot is not None:
            ...
            try:
                ...
                # Add Supervisor Name
                st.markdown("**👨‍💼 Supervisor Name:**")
                supervisor_name = st.text_input("Enter Supervisor Name:", value="Muhammad Talha", key="supervisor_name")
